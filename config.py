...
class Settings(BaseSettings):
    ...
    MAX_VOICEOVER_SIZE: int = 1 * 1024 * 1024 * 1024  # 1GB specifically for voiceover files
    MAX_VIDEO_SIZE: int = 5 * 1024 * 1024 * 1024  # 5GB specifically for video files (B-roll)
